...
import {TrustedBaseReactor} from "./TrustedBaseReactor.sol";
...
contract TrustedExclusiveDutchOrderReactor is TrustedBaseReactor {
    ...
    constructor(IPermit2 _permit2, address _protocolFeeOwner) TrustedBaseReactor(_permit2, _protocolFeeOwner) {}

    /// @inheritdoc TrustedBaseReactor
